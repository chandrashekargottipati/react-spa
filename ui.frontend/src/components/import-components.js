...
MapTo('bank-spa-react/components/download')(DownloadV1, {isEmpty: DownloadV1IsEmptyFn});
MapTo('bank-spa-react/components/list')(ListV2, {isEmpty: ListV2IsEmptyFn});
MapTo('bank-spa-react/components/separator')(SeparatorV1, {isEmpty: SeparatorV1IsEmptyFn});
...
MapTo('bank-spa-react/components/breadcrumb')(BreadCrumbV2, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('bank-spa-react/components/navigation')(NavigationV1);
MapTo('bank-spa-react/components/languagenavigation')(LanguageNavigationV1);


MapTo('bank-spa-react/components/tabs')(TabsV1, {isEmpty: TabsV1IsEmptyFn});
MapTo('bank-spa-react/components/accordion')(AccordionV1, {isEmpty: AccordionV1IsEmptyFn});
MapTo('bank-spa-react/components/carousel')(CarouselV1, {isEmpty: CarouselV1IsEmptyFn});
MapTo('bank-spa-react/components/container')(ContainerV1, {isEmpty: ContainerV1IsEmptyFn});
...
MapTo('bank-spa-react/components/text')(LazyTextComponent, TextEditConfig);